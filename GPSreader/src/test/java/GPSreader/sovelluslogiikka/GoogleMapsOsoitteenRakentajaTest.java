...
public class GoogleMapsOsoitteenRakentajaTest {
    ...
    public void osoitteenRakentajaPoluillaMuodostaaOsoitteenOikein() {
        ...
        String oikeaOsoite = "https://maps.googleapis.com/maps/api/staticmap?center=12.1,13.1&maptype=terrain&size=600x600&path=color:0x0000ff|weight:7|12.1,13.1|12.3,13.3&key=AIzaSyDqqBJ4sBUY34znGoJA9IXQ3e-n4iEKzuU";
